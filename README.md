...
<p align="center">
  <b>Integrated Mobile IDE, Multi-Session Terminal, and On-Device Build Environment for Android (ARM64).</b>
</p>

<p align="center">
  <a href="https://github.com/MonDevv-spec/termuXide/releases/latest">
    <img src="https://img.shields.io/github/v/release/MonDevv-spec/termuXide?color=blue&label=Latest%20Release" alt="Latest Release">
  </a>
  <img src="https://img.shields.io/badge/Platform-Android%207.0%2B-brightgreen" alt="Platform">
  <img src="https://img.shields.io/badge/Arch-aarch64%20(ARM64)-orange" alt="Architecture">
  <a href="https://t.me/modfreew">
...
- **Target SDK:** 28 (Preserves direct binary execution in app data directories)

---

## 📥 Download & Installation

Grab the latest standalone APK from the **[Releases Page](https://github.com/MonDevv-spec/termuXide/releases/latest)**.

1. Download `app-release.apk`.
2. Install the APK on your Android device (ensure installation from unknown sources is allowed).
3. Grant storage permission when prompted on onboarding.

---

## 🛡️ Credits & Disclaimer

TermuX is an independent derivative work built on the foundation of the open-source **[Termux](https://github.com/termux/termux-app)** project created by **Fredrik Fornwall** and the Termux community contributors.

---

## 💬 Community & Support

Join the official Telegram community for support, news, and updates:  
👉 **[Join Telegram Channel](https://t.me/modfreew)**
